let historyData = {
    ...
    goodUrl: {
        ...
        url: () => {
            ...
            if (rand === 0){
                historyData.constant = "easy"
            } else if (rand === 1 || rand === 2) {
                historyData.constant = "medium"
            } else {
                historyData.constant = "hard"
            }
            return `https://the-trivia-api.com/api/questions?categories=history&limit=1&difficulty=${historyData.constant}`}
    },
    randomUrl: {
        method: "get",
        url: () => {return `https://the-trivia-api.com/api/questions?categories=history&limit=1&difficulty=${historyData.constant}`}
    },

    GetData: function GetData(res) {
        let DataQuizz = {
            id: "1",
            gameName: "HistoryGame",
            heading: "",
            goodAnswer: "",
            info: {},
            infoTxt: <p></p>,
